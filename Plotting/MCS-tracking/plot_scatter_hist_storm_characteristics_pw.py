...
pw_max = 1e9
pw_min = 1e2
pw_bins =  np.logspace(2,9,num=15)
exp = 'exp3'
###########################################################
###########################################################
...
ax.set_ylabel("Total precip. water (mm)", fontsize='xx-large')
...
ax2.set_ylabel("Total precip. water (mm)", fontsize='xx-large')
...
ax3.set_ylabel("Total precip. water (mm)", fontsize='xx-large')

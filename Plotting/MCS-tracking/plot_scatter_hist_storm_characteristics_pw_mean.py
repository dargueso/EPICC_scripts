...
ax.set_ylabel("Mean precip. water (mm)", fontsize='xx-large')
...
ax2.set_ylabel("Mean precip. water (mm)", fontsize='xx-large')
...
ax3.set_ylabel("Mean precip. water (mm)", fontsize='xx-large')

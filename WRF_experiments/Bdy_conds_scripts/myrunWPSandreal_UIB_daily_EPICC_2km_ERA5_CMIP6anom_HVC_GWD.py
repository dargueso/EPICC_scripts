...
def sel_intfiles(filelist,sdate,edate):
    ...
    days=np.array([fname.split(":")[-1].split("-")[2][0:2] for fname in filelist],int)
...
indeck_wrf = "namelist_input_EPICC_2km_ERA5_CMIP6anom_HVC_GWD.deck"

this_dir = os.getcwd()
wrf_dir = "/home/dargueso/WRF_runs/EPICC_PGW_WRFV4.2.2/WRF/run"
wps_dir = "/home/dargueso/WRF_runs/EPICC_PGW_WRFV4.2.2/WPS"
grb_dir = "/vg6/dargueso-NO-BKUP/BDY_DATA/ERA5_CMIP6anom/"
bdy_dir = "/vg6/dargueso-NO-BKUP/BDY_DATA/ERA5_CMIP6anom/WRF-boundary/EPICC/EPICC_2km_ERA5_CMIP6anom_HVC_GWD/"
...
while (year < end_year or (year == end_year and month < end_month)):
    ...
    if (run_metgrid == True):
        ...
        subprocess.call(f"ln -sf {grb_dir}/WRF-Intermediate/SOILERA5:{year}* .", shell=True)

...
indeck = "runwrf_picasso_EPICC_2km_ERA5.deck"
...
BDY_dir = "/mnt2/fscratch/users/uib33_res/uib33145/WRF_BDY/EPICC_2km_ERA5"
...
RST_dir = "/mnt2/fscratch/users/uib33_res/uib33145/WRF_OUT/EPICC/EPICC_2km_ERA5/restart"
# scp flags required e.g. for port 6512 need "-P 6512"
RST_scpflags = ""
...
OUT_dir = "/mnt2/fscratch/users/uib33_res/uib33145/WRF_OUT/EPICC/EPICC_2km_ERA5/out"
# scp flags required e.g. for port 6512 need "-P 6512"
OUT_scpflags = " "
...
while year < end_year or (year == end_year and month < end_month):
    ...
    fout = open("runwrf_%s_%s_%s.deck" % (year, smonstr, sdaystr), "w")

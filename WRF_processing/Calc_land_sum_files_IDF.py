...
fin_pre = xr.open_dataset(f'{cfg.path_in}/{wrun_pre}/hist2d_resample_time_IFD_2013-2020_0.1mm.nc')
fin_fut = xr.open_dataset(f'{cfg.path_in}/{wrun_fut}/hist2d_resample_time_IFD_2013-2020_0.1mm.nc')
...
if reg=='':
    ...
    fin_pre_land.to_netcdf(f'{cfg.path_in}/{wrun_pre}/hist2d_resample_time_IFD_2013-2020_land_sum_0.1mm.nc')
    fin_fut_land.to_netcdf(f'{cfg.path_in}/{wrun_fut}/hist2d_resample_time_IFD_2013-2020_land_sum_0.1mm.nc')
    ...
    fin_pre_land.to_netcdf(f'{cfg.path_in}/{wrun_pre}/hist2d_resample_time_IFD_2013-2020_land_sum_{reg}_0.1mm.nc')
    fin_fut_land.to_netcdf(f'{cfg.path_in}/{wrun_fut}/hist2d_resample_time_IFD_2013-2020_land_sum_{reg}_0.1mm.nc')

...
for domain in domains:
    ...
    if domain=='d01':
        ...
        ax.add_feature(oce50m , zorder=103,facecolor=[24/255,  116/255,  205/255])
        ax.add_feature(cfeature.LAKES, zorder=103,linewidth=0.5,edgecolor='k',facecolor=[24/255,  116/255,  205/255])
        ...
        ax.plot(border_lon,border_lat,'k',transform=ccrs.PlateCarree(),zorder=103)
        ct1=ax.contourf(lon,lat,geo_file.HGT_M.squeeze(),levels=np.arange(-800,3400,200),cmap='terrain',extend='both',transform=ccrs.PlateCarree(),zorder=103)
        ax.coastlines(linewidth=0.4,zorder=103,resolution='50m')
